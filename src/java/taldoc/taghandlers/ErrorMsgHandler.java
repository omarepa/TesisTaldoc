 ...
 * @author edpena
 */
public class ErrorMsgHandler extends BodyTagSupport {
    ...
    private void otherDoStartTagOperations()
    {
        try
        {
            ...
            out.println("<table class='fancyTable'>"
                        + "<thead>"
                            + "<tr>"
                                + "<td>Mensaje:</td>"
                            + "</tr>"
        ...
        {
            System.out.println("Error en la tag library: otherDoStartTagOperations");
        }
    }
    ...
    private void otherDoEndTagOperations()
    {
        ...
        {
            System.out.println("Error en la tag library: otherDoEndTagOperations");
        }
    }
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in ErrorMsgHandler tag", ex);
    }
